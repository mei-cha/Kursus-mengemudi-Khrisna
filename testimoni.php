        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 mb-8">
            ...
            <div class="max-w-2xl mx-auto space-y-3">
                <?php for ($i = 5; $i >= 1; $i--): 
                    ...
                    $percentage = $count > 0 ? ($count / count($testimoni)) * 100 : 0;
                ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <select name="paket_kursus" required
                            ...
                            <option value="Kursus Manual">Paket Reguler</option>
                            <option value="Kursus Matic">Paket Campuran</option>
                            <option value="Kursus Kombinasi">Paket Extra</option>
                            <option value="Kursus Intensive">Paket Pelancaran</option>
                        </select>
                    </div>
                </div>
