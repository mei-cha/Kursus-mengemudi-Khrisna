                        ...
                        <form method="POST" enctype="multipart/form-data" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-2">Urutan
                                            Tampil</label>
                        ...
                        <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div>
                                ...
                                <select name="kategori"
                                    ...
                                    <option value="aktivitas" <?= $kategori_filter === 'aktivitas' ? 'selected' : '' ?>>
                                        Aktivitas</option>
                                    <option value="fasilitas" <?= $kategori_filter === 'fasilitas' ? 'selected' : '' ?>>
                                        Fasilitas</option>
                                    <option value="sertifikat" <?= $kategori_filter === 'sertifikat' ? 'selected' : '' ?>>
                                        Sertifikat</option>
                                    <option value="kendaraan" <?= $kategori_filter === 'kendaraan' ? 'selected' : '' ?>>
                                        Kendaraan</option>
                                    <option value="instruktur" <?= $kategori_filter === 'instruktur' ? 'selected' : '' ?>>
                                        Instruktur</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="status"
                                    ...
                                    <option value="aktif" <?= $status_filter === 'aktif' ? 'selected' : '' ?>>Aktif
                                    </option>
                        ...
                        <?php if (count($galeri) > 0): ?>
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                                <?php foreach ($galeri as $data): ?>
                                    <div
                                        class="bg-gray-50 rounded-lg border border-gray-200 overflow-hidden hover:shadow-md transition duration-300">
                                        <!-- Image -->
                                        <div class="relative group">
                                            <img src="../assets/images/galeri/<?= $data['gambar'] ?>"
                                                alt="<?= htmlspecialchars($data['judul']) ?>" class="w-full h-48 object-cover">
                                            ...
                                            <div
                                                ...
                                                <div class="flex space-x-2">
                                                    <button
                                                        onclick="viewImage('<?= $data['gambar'] ?>', '<?= htmlspecialchars($data['judul']) ?>')"
                                        ...
                                        <div class="p-4">
                                            <h4 class="font-bold text-gray-800 text-sm mb-1">
                                                <?= htmlspecialchars($data['judul']) ?></h4>
                                            <p class="text-gray-600 text-xs mb-2"><?= htmlspecialchars($data['deskripsi']) ?>
                                            </p>
