...
<div class="sidebar-container">
    <!-- Sidebar -->
    <div id="sidebar" class="sidebar bg-white shadow-lg w-64 flex flex-col fixed lg:relative h-screen z-50 left-0 top-0 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out">
        ...
        <div class="p-6 border-b border-gray-200 bg-white flex items-center justify-between">
            ...
            <button id="close-sidebar" class="lg:hidden text-gray-500 hover:text-gray-700 bg-gray-100 hover:bg-gray-200 p-2 rounded-lg transition-colors">
        ...
        <nav class="flex-1 px-4 py-6 bg-white overflow-y-auto">
            <ul class="space-y-2">
                ...
                <li>
                    <a href="jadwal.php" class="flex items-center px-4 py-3 rounded-lg font-medium <?= $current_page == 'jadwal.php' ? 'text-blue-600 bg-blue-50' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50' ?>">
                ...
                <li>
                    <a href="edit-footer.php" class="flex items-center px-4 py-3 rounded-lg font-medium <?= $current_page == 'edit-footer.php' ? 'text-blue-600 bg-blue-50' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50' ?>">
                        <i class="fas fa-edit w-6 mr-3"></i>
                        <span class="sidebar-text">Edit Footer</span>
                    </a>
                </li>
