...
<section id="paket-kursus" class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <!-- Paket Reguler -->
            <div
                class="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition duration-300 transform hover:-translate-y-2">
                <div
                ...
                <?php foreach ($instruktur as $inst): ?>
                    <div class="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition duration-300">
                        <div class="flex items-start space-x-4">
                            <div
                                class="w-20 h-20 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center shadow-md">
                            ...
                            <div class="flex-1">
                                <h3 class="text-xl font-bold text-gray-800 mb-1"><?= htmlspecialchars($inst['nama_lengkap']) ?>
                                </h3>
                                <div class="flex items-center mb-2">
                                    <div class="text-yellow-400 mr-2">
                                        <?= str_repeat('★', floor($inst['rating'])) ?>
                                        <?= str_repeat('☆', 5 - floor($inst['rating'])) ?>
                                    </div>
                                    <span class="text-gray-600 text-sm">(<?= number_format($inst['rating'], 1) ?>)</span>
                                </div>
                                <p class="text-blue-600 font-semibold mb-2"><?= $inst['pengalaman_tahun'] ?>+ Tahun Pengalaman
                                </p>
                                <p class="text-gray-600 text-sm mb-3">Spesialis: <?= ucfirst($inst['spesialisasi']) ?></p>
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    <?= htmlspecialchars($inst['deskripsi'] ?? 'Instruktur profesional berpengalaman') ?>
                                </p>
                            </div>
                        </div>
                    </div>
...
<section id="daftar" class="py-16 bg-gray-50">
    <div class="max-w-4xl mx-auto px-4">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 md:p-8">
            <form id="formPendaftaran" action="proses-pendaftaran.php" method="POST" class="space-y-7">
                <!-- Data Pribadi -->
                <div class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                        ...
                        <div>
                            <label for="pengalaman" class="block text-sm text-gray-700 mb-1">Pengalaman</label>
                ...
                <div class="space-y-5 pt-4 border-t border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                        ...
                        <div>
                            <label for="tanggal_kursus" class="block text-sm text-gray-700 mb-1">Tanggal Mulai
                                (Opsional)</label>
                    ...
                    <div>
                        <label class="block text-sm text-gray-700 mb-2">Jadwal Preferensi *</label>
                        <div class="flex flex-wrap gap-3">
                            <?php $jadwal_opsi = ['Pagi', 'Siang', 'Sore', 'Malam']; ?>
                            <?php foreach ($jadwal_opsi as $opsi): ?>
                                <label class="flex items-center">
                                    <input type="checkbox" name="jadwal_preferensi[]" value="<?= $opsi ?>"
                                        class="w-4 h-4 text-blue-600 rounded focus:ring-blue-500">
                                    <span class="ml-2 text-gray-700"><?= $opsi ?></span>
                                </label>
                            <?php endforeach; ?>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            <label for="kontak_darurat" class="block text-sm text-gray-700 mb-1">Nomor Kontak
                                Darurat</label>
                            <input type="tel" id="kontak_darurat" name="kontak_darurat" placeholder="081234567890"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition">
                        </div>
                    </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const cardWidth = container.querySelector('.flex-shrink-0').offsetWidth + 24; // 24 = gap-6 = 1.5rem = 24px
